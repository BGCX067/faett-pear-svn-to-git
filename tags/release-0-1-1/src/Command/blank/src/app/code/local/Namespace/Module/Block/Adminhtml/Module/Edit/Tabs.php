...
/**
 * <Namespace>_<Module>_Block_Adminhtml_<Module>_Edit_Tabs
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class <Namespace>_<Module>_Block_Adminhtml_<Module>_Edit_Tabs
  	...
  	protected function _beforeToHtml()
  	{
      	$this->addTab('form_section', array(
          	...
          	'content'   => $this->getLayout()->createBlock(
          		'<module>/adminhtml_<module>_edit_tab_form'
      		)->toHtml(),
      	));
