...
class PEAR_Command_Mage extends PEAR_Command_Common
{
    ...
    public function doProject($command, $options, $params)
    {
        ...
        $fromFiles = array(
            ...
            'data/Faett_PEAR/Command/blank/tests/app/code/local/Namespace/Module/AllTests.php',
        ...
        $toFiles = array(
            ...
            $this->_capNamespace . '_' . $this->_capModule . '/tests/app/code/local/' . $this->_capNamespace . '/' . $this->_capModule. '/AllTests.php',
